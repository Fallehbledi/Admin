        ...
        <tr>
          ...
          <td className="px-6 py-4 text-center flex justify-between items-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-red text-white text-base font-medium rounded-md shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 ml-4"
            >
              Cancel
            </button>
          </td>
